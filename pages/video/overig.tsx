...
const VideoOverig: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Ronald Bergman | Overige werkzaamheden</title>
        <meta
          name='description'
      ...
      <Page background='video'>
        ...
        <Container>
          ...
          <nav className={styles.nav}>
            <div>
              Naast digitalisering en registratie bied ik ook de volgende
              diensten aan:
            </div>
            <ul>
              <li>
          ...
          <section ref={programmaboekjesRef}>
            ...
            <p>
              ...
              historische info. Deze heb ik aangevuld met foto’s van
              afbeeldingen die de tekst illustreren.
            </p>
          ...
          <section ref={muziekRef}>
            ...
            <p>
              ...
              pianostuk van Claude Debussy gespeeld door Ida Wildvank en heb
              daar een video gemaakt met filmbeelden uit de tijd waarin deze
              muziek is geschreven nl. de film Parijs 1900. De beelden zijn meer
              dan 70 jaar oud dus ik hoefde geen rekening te houden met
              auteursrechten.
            </p>
            <Video
          ...
          <section ref={videoRef}>
            ...
            <p>
              Ik heb een video a.d.h.v. foto’s gemaakt waarin de ontwikkeling
              van een schilderij als metamorfose is te zien van uitgescheurde
              vormpjes papier tot schilderij. Wij hadden Margriet Snaterse
              opdracht gegeven om voor onze tuin een schilderij te maken waarin
              onze passie voor dans uit de barok en klassieke muziek uit Sunda,
              West-Java, in één schilderij te laten zien. Als achtergrond een
              symbiose van landschappen van Toscana en Sunda, West Java.
            </p>
          ...
          <section ref={teasersRef}>
            ...
            <p>
              ...
              publiek een opname te maken van een interview met twee
              beroemdheden nl. jazzmusicus en jazzveteraan Ack van Rooyen en tv
              presentator Matthijs van Nieuwkerk. Aansluitend volgde een
              muziekoptreden. Hieraan heb ik als 2e cameraman en editor
              meegewerkt. Deze opname zou in een later stadium worden gestreamd.
              Om dit gebeuren alvast in de media bekend te maken kreeg ik als
              opdracht een teaser te maken van een selectie van 17 minuten aan
              videomateriaal uit een vorig optreden. Hieruit heb ik deze teaser
              van 22 seconden gemaakt.
            </p>
            <Video
            ...
            <p>
              ...
              betrokkenheidsreacties op dezelfde account. Hier een weergave
              vanuit mijn You Tubekanaal in hoge kwaliteit.
            </p>
          ...
          <section ref={clipsRef}>
            ...
            <p>
              Huwelijksreportages vind ik leuk om te doen maar mijn voorkeur
              ligt toch meer in de kunstwereld. Hier een clip met een
              samenvatting van een reportage die ik in 2006 heb gemaakt met mijn
              vorige camera.
            </p>
          ...
          <section ref={muziekVervangenRef}>
            ...
            <p>
              ...
              Gelukkig werd gebruikt gemaakt van een keuze uit een 20-tal cd’s
              die ik allemaal heb opgevraagd. Van hieruit verving ik een 30-tal
              ...
              corrigeren. Daar ging heel veel tijd mee gemoeid gezien het feit
              dat dit om honderdste seconden ging en de hoeveelheid dansnummers.
              Hier een klein stukje als voorbeeld.
            </p>
            <Video
            ...
            />
            <p>
              U ziet dat de video meer cachet heeft gekregen door deze
              toevoeging.
            </p>
          </section>
        </Container>
