...
const Digitalisering: NextPage = () => {
  return (
    <>
      <Head>
        <title>Ronald Bergman | Digitalisering</title>
        <meta
          name='description'
      ...
      <Page background='video'>
        ...
        <Container>
          <section>
            ...
            <p>
              1) Met <span className='bold'>capture</span> (verkrijgen) kan ik
              het analoog materiaal in de vorm van VHS, Hi8 en VCI-videobanden
              omzetten in een tijdelijke digitale vorm zoals b.v. een
              MV4-bestand welke ik op een DVD zet.
            </p>
            <p>
            ...
            <p>
              ...
              gedigitaliseerde materiaal schoonpoetsen door fletse kleuren,
              doffe audio helder te maken en te versterken en slechte stukken te
              verwijderen.
            </p>

            <p>
              3) Met <span className='bold'>editing</span> kan ik titels en
              overgangen aanbrengen en nieuwe audio, foto’s en video’s
              toevoegen. En dan moet dit geheel nog kunnen worden afgespeeld.
            </p>
            ...
            <p>
              ...
              zodat u het materiaal zelf op het net kan zetten bijvoorbeeld op
              uw eigen kanaal op genoemde media. In plaats van een menu maak ik
              een tijdschema met alle hoofdstukken welke u in de omschrijving
              bij uw media kunt toevoegen.
            </p>
            <div>
          ...
          <section>
            ...
            <p>
              ...
              historische optredens van grote meesters in de muziek. Niemand
              keek hier meer naar om en zo raakten de registraties in dit
              gedateerde format in de vergetelheid.
            </p>
            <p>
              ...
              met als resultaat een eindproduct waar iedereen nu heel erg trots
              op is.
            </p>
            <p>
