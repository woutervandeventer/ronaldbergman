...
const Muziek: NextPage = () => {
  return (
    <>
      <Head>
        <title>Ronald Bergman | Indonesië</title>
        <meta
          name='description'
        ...
        <Container>
          <section>
            ...
            <p>
              ...
              voorgedragen op gedichten van o.a. Goethe. Dit ensemble bestaat
              uit 4 personen: een zangeres, 2 citherspelers en ik als fluitist.
              Ik speel hier suling, een Sundanese bamboefluit waarop de overige
            ...
            <p>
              Wat u net hoorde was de eerste serie liederen die we op een
              concert tijdens het Gergiev festival in Rotterdam speelden. Hier
              een{' '}
              <a
              ...
              van dit concert in zijn geheel inclusief een mondelinge
              toelichting door Wim van Zanten.
            </p>
            <p>
              ...
              contrast met het grote lawaai buiten in de grote steden. Concerten
              vinden meestal plaats in landen buiten Indonesië.
            </p>
            <p>
            ...
            <p>
              ...
              uitgenodigd om in zijn groep mee te spelen tijdens een pop venue
              in het Amsterdamse Bos. Als slot een optreden tijdens de{' '}
              <span className='bold'>75e Indiëherdenking</span> op 15 augustus
              2020. Dat vond ik een grote eer. Ik heb dit als een prachtige
              samenwerking ervaren waarbij we een symbiose met Oost en West
              hebben kunnen bereiken. Van het laatste optreden een televisie
              opname door NPO:
            </p>
            <Video src='https://www.youtube.com/embed/L0qXfbPdeT0' />
            <p>
              Mocht u belangstelling hebben voor deze muziek klik op dit
              formulier, tevens contactformulier waarop alle benodigde
              informatie staat en waarop u uw wensen kenbaar kunt maken.
            </p>
            <div>
