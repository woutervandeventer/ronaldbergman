...
const Muziek: NextPage = () => {
  return (
    <>
      <Head>
        <title>Ronald Bergman | Brazilië</title>
        <meta
          name='description'
      ...
      <Page>
        ...
        <Container>
          <section>
            ...
            <p>
              Braziliaanse muziek in deze setting is heel erg geschikt voor
              kleine evenementen. Het publiek kan er naar gaan luisteren of er
              op dansen. Ook is het geschikt als achtergrondmuziek maar de
              ervaring leert dat het publiek niet kan stilzitten.
            </p>
          </section>
        </Container>
      </Page>
